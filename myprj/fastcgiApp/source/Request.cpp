...
void Request::setMethod(const string& str)
{
    m_method = str;
}

void Request::setUrl(const string& str)
{
    m_url = str;
}

//params: user=aabbcc&passwd=aabbcc
void Request::setParams(const string& str)
{
    m_params = str;
    parseParam(m_params, m_paramsMap);
}

void Request::setToken(const string& str)
{
	if(m_method == "GET")
    {
    ...
    else if(m_method == "POST")
    {
        ...
        CMyRedis::ptr myRedis = CMyRedis::getInstance("127.0.0.1",6379,"klczxas741789");
...
void Response::setSetToken(const string& str)
{
    m_setToken = str;
}

void Response::setResData(const string& str)
{
    m_resData = str;
}
...
string Response::Out()
{
    //const string& strSetToken = m_setToken.toSetTokenStr();
